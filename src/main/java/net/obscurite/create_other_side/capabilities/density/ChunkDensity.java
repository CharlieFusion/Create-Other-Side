...
public class ChunkDensity {
    ...
    private final double MIN_DENSITY = 0.0;
    private final double MAX_DENSITY = 100.0;

    public double getDensity() {
        return density;
    }

    public void changeDensity(double value) {
        this.density = Math.min(Math.max(density + value, 0.0), 100.0);
    }
